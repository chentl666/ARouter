package com.ctl.arouter.compiler.factory;

import com.ctl.arouter.annotation.Parameter;
import com.ctl.arouter.compiler.utils.Constants;
import com.ctl.arouter.compiler.utils.EmptyUtils;
    ...
    public void buildStatement(Element element) {
        ...
        if (type == TypeKind.INT.ordinal()) {
            ...
            if (typeMirror.toString().equalsIgnoreCase(Constants.STRING)) {
                ...
                // t.s = t.getIntent.getExtras();
                methodContent += "getExtras()";
        ...
        if (methodContent.endsWith(")")) {
            ...
            messager.printMessage(Diagnostic.Kind.ERROR, "目前暂支持String、int、boolean、bundle传参");
        }
    }
